<div class="nav"><a class="btn btn-expanded"></a>
  <nav class="nav-main-menu">
    <ul class="main-menu">
      <li> <a class="dashboard2 active" href="/admin"><img src="backend/assets/imgs/page/dashboard/dashboard.svg" alt="jobBox"><span class="name">Dashboard</span></a>
      </li>
      <li> <a class="dashboard2" href="admin/candidates"><img src="backend/assets/imgs/page/dashboard/candidates.svg" alt="jobBox"><span class="name">Candidates</span></a>
      </li>
      <li> <a class="dashboard2" href="admin/companies"><img src="backend/assets/imgs/page/dashboard/recruiters.svg" alt="jobBox"><span class="name">Companies</span></a>
      </li>
      <li> <a class="dashboard2" href="admin/jobs"><img src="backend/assets/imgs/page/dashboard/jobs.svg" alt="jobBox"><span class="name">All Jobs</span></a>
      </li>
      ...
      <li> <a class="dashboard2" href="admin/profile"><img src="backend/assets/imgs/page/dashboard/profiles.svg" alt="jobBox"><span class="name">My Profiles</span></a>
      </li>
