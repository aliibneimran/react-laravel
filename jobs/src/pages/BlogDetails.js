...
<main className="main">
  <section className="section-box">
    <div><img src="assets/imgs/page/blog/img-single.png" alt=''/></div>
  </section>
  <section className="section-box">
    <div className="archive-header pt-50 text-center">
      <div className="container">
        <div className="box-white">
          <div className="max-width-single"><Link className="btn btn-tag" to="#">Job Tips</Link>
            ...
            <div className="post-meta text-muted d-flex align-items-center mx-auto justify-content-center">
              <div className="author d-flex align-items-center mr-30"><img alt="jobBox" src="assets/imgs/page/homepage1/user3.png" /><span>Sarah Harding</span></div>
              <div className="date"><span className="font-xs color-text-paragraph-2 mr-20 d-inline-block"><img className="img-middle mr-5" src="assets/imgs/page/blog/calendar.svg"alt=''/> 06 Sep 2022</span><span className="font-xs color-text-paragraph-2 d-inline-block"><img className="img-middle mr-5" src="assets/imgs/template/icons/time.svg" alt=''/> 8 mins to read</span></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-lg-10 mx-auto">
          <div className="single-body">
            ...
            <figure><img src="assets/imgs/page/blog/img-content.png" alt=''/></figure>
            <div className="max-width-single">
              ...
              <div className="single-apply-jobs mt-20">
                <div className="row">
                  <div className="col-lg-7"><Link className="btn btn-border-3 mr-10 hover-up" to="#"># Nature</Link><Link className="btn btn-border-3 mr-10 hover-up" to="#"># Beauty</Link><Link className="btn btn-border-3 hover-up" to="#"># Travel tips</Link></div>
                  <div className="col-md-5 text-lg-end social-share">
                    <h6 className="color-text-paragraph-2 d-inline-block d-baseline mr-20 mt-10">Share</h6><Link className="mr-20 d-inline-block d-middle hover-up" to="#"><img alt="jobBox" src="assets/imgs/page/blog/fb.svg" /></Link><Link className="mr-20 d-inline-block d-middle hover-up" to="#"><img alt="jobBox" src="assets/imgs/page/blog/tw.svg" /></Link><Link className="mr-0 d-inline-block d-middle hover-up" to="#"><img alt="jobBox" src="assets/imgs/page/blog/pi.svg" /></Link>
                  </div>
                </div>
              </div>
              <h3>Comments</h3>
              <ul className="list-comments">
                <li>
                  <div className="author-bio mt-40 bg-white">
                    <div className="author-image mb-15"><Link to="author"><img className="avatar" src="assets/imgs/page/candidates/user5.png" alt='' /></Link>
                ...
                <li>
                  <div className="author-bio mt-40 bg-white">
                    <div className="author-image mb-15"><Link to="author"><img className="avatar" src="assets/imgs/page/candidates/user1.png" alt='' /></Link>
                      <div className="author-infor">
                  ...
                  <ul>
                    <li>
                      <div className="author-bio mt-40 bg-white">
                        <div className="author-image mb-15"><Link to="author"><img className="avatar" src="assets/imgs/page/candidates/user3.png" alt='' /></Link>
                          <div className="author-infor">
                    ...
                    <div className="row">
                      <div className="col-lg-6 col-md-6 col-sm-7 mb-30">
                        <label className="box-agree">
                          <input className="chkbox-aggree" type="checkbox" /><span className="font-sm color-text-paragraph">Save my name, email, and website in this browser for the next time I comment.</span>
                        </label>
                      </div>
