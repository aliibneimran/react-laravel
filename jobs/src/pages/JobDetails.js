      ...
      <div className="row">
          ...
          <div className="box-border-single">
            <div className="row mt-10">
              <div className="col-lg-8 col-md-12">
                ...
                <div className="mt-0 mb-15"><span className="card-briefcase">Fulltime</span><span className="card-time">3 mins ago</span></div>
              </div>
            ...
            <div className="banner-hero banner-image-single mt-10 mb-20"><img src="assets/imgs/page/job-single-2/img.png" alt="jobBox" /></div>
            <div className="job-overview">
              <h5 className="border-bottom pb-15 mb-30">Overview</h5>
              <div className="row">
                <div className="col-md-6 d-flex">
                  <div className="sidebar-icon-item"><img src="assets/imgs/page/job-single/industry.svg" alt="jobBox" /></div>
                  <div className="sidebar-text-info ml-10"><span className="text-description industry-icon mb-10">Industry</span><strong className="small-heading"> Mechanical / Auto / Automotive, Civil / Construction</strong></div>
                </div>
                <div className="col-md-6 d-flex mt-sm-15">
                  <div className="sidebar-icon-item"><img src="assets/imgs/page/job-single/job-level.svg" alt="jobBox" /></div>
                  <div className="sidebar-text-info ml-10"><span className="text-description joblevel-icon mb-10">Job level</span><strong className="small-heading">Experienced (Non - Manager)</strong></div>
                </div>
              </div>
              <div className="row mt-25">
                <div className="col-md-6 d-flex mt-sm-15">
                  <div className="sidebar-icon-item"><img src="assets/imgs/page/job-single/salary.svg" alt="jobBox" /></div>
                  <div className="sidebar-text-info ml-10"><span className="text-description salary-icon mb-10">Salary</span><strong className="small-heading">$800 - $1000</strong></div>
                </div>
                <div className="col-md-6 d-flex">
                  <div className="sidebar-icon-item"><img src="assets/imgs/page/job-single/experience.svg" alt="jobBox" /></div>
              ...
              <div className="row mt-25">
                <div className="col-md-6 d-flex mt-sm-15">
                  ...
                  <div className="sidebar-text-info ml-10"><span className="text-description jobtype-icon mb-10">Job type</span><strong className="small-heading">Permanent</strong></div>
                </div>
                <div className="col-md-6 d-flex mt-sm-15">
              ...
              <div className="row mt-25">
                <div className="col-md-6 d-flex mt-sm-15">
                  <div className="sidebar-icon-item"><img src="assets/imgs/page/job-single/updated.svg" alt="jobBox" /></div>
                  <div className="sidebar-text-info ml-10"><span className="text-description jobtype-icon mb-10">Updated</span><strong className="small-heading">10/07/2022</strong></div>
                </div>
                <div className="col-md-6 d-flex mt-sm-15">
                  <div className="sidebar-icon-item"><img src="assets/imgs/page/job-single/location.svg" alt="jobBox" /></div>
                  <div className="sidebar-text-info ml-10"><span className="text-description mb-10">Location</span><strong className="small-heading">Dallas, Texas Remote Friendly</strong></div>
                </div>
              </div>
            </div>
            ...
            <div className="author-single"><span>AliThemes</span></div>
            <div className="single-apply-jobs">
              <div className="row align-items-center">
                <div className="col-md-5"><Link className="btn btn-default mr-15" to="#">Apply now</Link><Link className="btn btn-border" to="#">Save job</Link></div>
                <div className="col-md-7 text-lg-end social-share">
                  <h6 className="color-text-paragraph-2 d-inline-block d-baseline mr-10">Share this</h6><Link className="mr-5 d-inline-block d-middle" to="#"><img alt="jobBox" src="assets/imgs/template/icons/share-fb.svg" /></Link><Link className="mr-5 d-inline-block d-middle" to="#"><img alt="jobBox" src="assets/imgs/template/icons/share-tw.svg" /></Link><Link className="mr-5 d-inline-block d-middle" to="#"><img alt="jobBox" src="assets/imgs/template/icons/share-red.svg" /></Link><Link className="d-inline-block d-middle" to="#"><img alt="jobBox" src="assets/imgs/template/icons/share-whatsapp.svg" /></Link>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
          <div className="sidebar-border">
            <div className="sidebar-heading">
              <div className="avatar-sidebar">
                ...
                <div className="sidebar-info"><span className="sidebar-company">AliThemes</span><span className="card-location">New York, US</span><Link className="link-underline mt-15" to="#">02 Open Jobs</Link></div>
              </div>
            </div>
              ...
              <ul>
                <li>
                  <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                    <div className="image"><Link to="job-details"><img src="assets/imgs/brands/brand-1.png" alt="jobBox" /></Link></div>
                    <div className="info-text">
                      <h5 className="font-md font-bold color-brand-1"><Link to="job-details">UI / UX Designer fulltime</Link></h5>
                ...
                <li>
                  <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                    <div className="image"><Link to="job-details"><img src="assets/imgs/brands/brand-2.png" alt="jobBox" /></Link></div>
                    <div className="info-text">
                      <h5 className="font-md font-bold color-brand-1"><Link to="job-details">Java Software Engineer</Link></h5>
                ...
                <li>
                  <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                    <div className="image"><Link to="job-details"><img src="assets/imgs/brands/brand-3.png" alt="jobBox" /></Link></div>
                    <div className="info-text">
                      <h5 className="font-md font-bold color-brand-1"><Link to="job-details">Frontend Developer</Link></h5>
                ...
                <li>
                  <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                    <div className="image"><Link to="job-details"><img src="assets/imgs/brands/brand-4.png" alt="jobBox" /></Link></div>
                    <div className="info-text">
                      <h5 className="font-md font-bold color-brand-1"><Link to="job-details">Cloud Engineer</Link></h5>
                ...
                <li>
                  <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                    <div className="image"><Link to="job-details"><img src="assets/imgs/brands/brand-5.png" alt="jobBox" /></Link></div>
                    <div className="info-text">
                      <h5 className="font-md font-bold color-brand-1"><Link to="job-details">DevOps Engineer</Link></h5>
                ...
                <li>
                  <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                    <div className="image"><Link to="job-details"><img src="assets/imgs/brands/brand-6.png" alt="jobBox" /></Link></div>
                    <div className="info-text">
                      <h5 className="font-md font-bold color-brand-1"><Link to="job-details">Figma design UI/UX</Link></h5>
                ...
                <li>
                  <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                    <div className="image"><Link to="job-details"><img src="assets/imgs/brands/brand-7.png" alt="jobBox" /></Link></div>
                    <div className="info-text">
                      <h5 className="font-md font-bold color-brand-1"><Link to="job-details">Product Manage</Link></h5>
                ...
                <li>
                  <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                    <div className="image"><Link to="job-details"><img src="assets/imgs/brands/brand-8.png" alt="jobBox" /></Link></div>
                    <div className="info-text">
                      <h5 className="font-md font-bold color-brand-1"><Link to="job-details">UI / UX Designer</Link></h5>
          ...
          <div className="sidebar-border">
            ...
            <div className="sidebar-list-job"><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">App</Link><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">Digital</Link><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">Marketing</Link><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">Conten Writer</Link><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">Sketch</Link><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">PSD</Link><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">Laravel</Link><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">React JS</Link><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">HTML</Link><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">Finance</Link><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">Manager</Link><Link className="btn btn-grey-small bg-14 mb-10 mr-5" to="jobs-grid">Business</Link></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section className="section-box mt-50 mb-50">
    <div className="container">
      ...
      <div className="mt-50">
              ...
              <div className="swiper-slide">
                <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                  <div className="card-grid-2-image-left"><span className="flash" />
                    ...
                    <div className="right-info"><Link className="name-job" to="company-details">Quora JSC</Link><span className="location-small">New York, US</span></div>
                  </div>
                  <div className="card-block-info">
                    <h6><Link to="job-details">Senior System Engineer</Link></h6>
                    ...
                    <div className="mt-30"><Link className="btn btn-grey-small mr-5" to="job-details">PHP</Link><Link className="btn btn-grey-small mr-5" to="job-details">Android  </Link></div>
                    <div className="card-2-bottom mt-30">
                      <div className="row">
                        <div className="col-lg-7 col-7"><span className="card-text-price">$800</span><span className="text-muted">/Hour</span></div>
                        <div className="col-lg-5 col-5 text-end"><Link className="btn btn-apply-now" to="job-details">Apply now</Link></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="swiper-slide">
                <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                  <div className="card-grid-2-image-left"><span className="flash" />
                    ...
                    <div className="right-info"><Link className="name-job" to="company-details">Dailymotion</Link><span className="location-small">New York, US</span></div>
                  </div>
                  <div className="card-block-info">
                    <h6><Link to="job-details">Frontend Developer</Link></h6>
                    ...
                    <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                    <div className="mt-30"><Link className="btn btn-grey-small mr-5" to="jobs-grid">Typescript</Link><Link className="btn btn-grey-small mr-5" to="jobs-grid">Java</Link></div>
                    <div className="card-2-bottom mt-30">
                      <div className="row">
              ...
              <div className="swiper-slide">
                <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                  <div className="card-grid-2-image-left"><span className="flash" />
                    ...
                    <div className="right-info"><Link className="name-job" to="company-details">Periscope</Link><span className="location-small">New York, US</span></div>
                  </div>
                  <div className="card-block-info">
                    <h6><Link to="job-details">Lead Quality Control QA</Link></h6>
                    <div className="mt-5"><span className="card-briefcase">Full time</span><span className="card-time">6<span> minutes ago</span></span></div>
                    <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                    <div className="mt-30"><Link className="btn btn-grey-small mr-5" to="job-details">iOS</Link><Link className="btn btn-grey-small mr-5" to="job-details">Laravel</Link><Link className="btn btn-grey-small mr-5" to="job-details">Golang</Link></div>
                    <div className="card-2-bottom mt-30">
                      <div className="row">
                        <div className="col-lg-7 col-7"><span className="card-text-price">$250</span><span className="text-muted">/Hour</span></div>
                        <div className="col-lg-5 col-5 text-end"><Link className="btn btn-apply-now" to="job-details">Apply now</Link></div>
        ...
        <div className="text-center"><Link className="btn btn-grey" to="#">Load more posts</Link></div>
      </div>
    </div>
  </section>
  <section className="section-box mt-50 mb-50">
              ...
              <div className="swiper-slide">
                <div className="card-grid-2 hover-up">
                  ...
                  <div className="card-block-info">
                    ...
                    <div className="mt-5"><span className="card-briefcase">Part time</span><span className="card-time">5<span> minutes ago</span></span></div>
                    <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                    <div className="mt-30"><Link className="btn btn-grey-small mr-5" to="job-details">PHP</Link><Link className="btn btn-grey-small mr-5" to="job-details">Android  </Link>
                    </div>
                    <div className="card-2-bottom mt-30">
                      <div className="row">
                        <div className="col-lg-7 col-7"><span className="card-text-price">$800</span><span className="text-muted">/Hour</span></div>
              ...
              <div className="swiper-slide">
                <div className="card-grid-2 hover-up">
                  ...
                  <div className="card-block-info">
                    ...
                    <div className="mt-5"><span className="card-briefcase">Full time</span><span className="card-time">6<span> minutes ago</span></span></div>
                    <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                    <div className="mt-30"><Link className="btn btn-grey-small mr-5" to="jobs-grid">Typescript</Link><Link className="btn btn-grey-small mr-5" to="jobs-grid">Java</Link>
                    </div>
                    <div className="card-2-bottom mt-30">
                      <div className="row">
                        <div className="col-lg-7 col-7"><span className="card-text-price">$250</span><span className="text-muted">/Hour</span></div>
              ...
              <div className="swiper-slide">
                <div className="card-grid-2 hover-up">
                  ...
                  <div className="card-block-info">
                    ...
                    <div className="mt-5"><span className="card-briefcase">Full time</span><span className="card-time">6<span> minutes ago</span></span></div>
                    <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                    <div className="mt-30"><Link className="btn btn-grey-small mr-5" to="job-details">iOS</Link><Link className="btn btn-grey-small mr-5" to="job-details">Laravel</Link><Link className="btn btn-grey-small mr-5" to="job-details">Golang</Link>
                    </div>
                    <div className="card-2-bottom mt-30">
                      <div className="row">
                        <div className="col-lg-7 col-7"><span className="card-text-price">$250</span><span className="text-muted">/Hour</span></div>
