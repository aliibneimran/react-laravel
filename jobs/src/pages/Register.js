      ...
      <div className="row login-register-cover">
        <div className="col-lg-4 col-md-6 col-sm-12 mx-auto">
          <div className="text-center">
            ...
            <button className="btn social-login hover-up mb-20"><img src="assets/imgs/template/icons/icon-google.svg" alt="jobbox" /><strong>Sign up with Google</strong></button>
          ...
          <form className="login-register text-start mt-20" action="#">
            ...
            <div className="login_footer form-group d-flex justify-content-between">
              ...
              </label><Link className="text-muted" to="contact">Lean more</Link>
            </div>
            <div className="form-group">
