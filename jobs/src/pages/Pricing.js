...
<main className="main">
          ...
          <div className="row">
            <div className="col-xl-4 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
              <div className="box-pricing-item">
                <h3>Basic</h3>
                <div className="box-info-price"><span className="text-price color-brand-2">$19</span><span className="text-month">/month</span></div>
                ...
                <div><Link className="btn btn-border" to="#">Choose plan</Link></div>
              </div>
            </div>
            <div className="col-xl-4 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
              <div className="box-pricing-item">
                <h3>Standard</h3>
                <div className="box-info-price"><span className="text-price for-month display-month">$29</span><span className="text-month">/month</span></div>
                <div className="border-bottom mb-30">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
              <div className="box-pricing-item">
                <h3>Enterprıse</h3>
                <div className="box-info-price"><span className="text-price for-month display-month">$49</span><span className="text-month">/month</span></div>
                <div className="border-bottom mb-30">
                  <p className="text-desc-package mb-30">For most businesses that want to otpimize web queries</p>
                </div>
                <ul className="list-package-feature">
  ...
  <section className="section-box mt-90 mb-50">
    <div className="container">
      ...
      <div className="font-lg color-text-paragraph-2 text-center wow animate__animated animate__fadeInUp">Aliquam a augue suscipit, luctus neque purus ipsum neque dolor<br className="d-none d-lg-block" /> primis a libero tempus, blandit and cursus varius and magnis sapien</div>
