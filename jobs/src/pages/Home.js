    ...
    <div className="banner-hero hero-2">
      <div className="banner-inner">
        <div className="block-banner">
          ...
          <div className="list-tags-banner mt-20 wow animate__animated animate__fadeInUp" data-wow-delay=".3s"><strong>Popular Searches:</strong><Link to="#">Designer</Link>, <Link to="#">Web</Link>, <Link to="#">IOS</Link>, <Link to="#">Developer</Link>, <Link to="#">PHP</Link>, <Link to="#">Senior</Link>, <Link to="#">Engineer</Link></div>
        </div>
        <div className="mt-60">
          <div className="row">
        ...
        <div className="box-swiper">
          <div className="swiper-container swiper-group-9 swiper">
            <div className="swiper-wrapper">
              <div className="swiper-slide"><Link to="#"><img src="assets/imgs/slider/logo/microsoft.svg" alt="jobBox" /></Link></div>
              <div className="swiper-slide"><Link to="#"><img src="assets/imgs/slider/logo/sony.svg" alt="jobBox" /></Link></div>
              <div className="swiper-slide"><Link to="#"><img src="assets/imgs/slider/logo/acer.svg" alt="jobBox" /></Link></div>
              <div className="swiper-slide"><Link to="#"><img src="assets/imgs/slider/logo/nokia.svg" alt="jobBox" /></Link></div>
              <div className="swiper-slide"><Link to="#"><img src="assets/imgs/slider/logo/assus.svg" alt="jobBox" /></Link></div>
              <div className="swiper-slide"><Link to="#"><img src="assets/imgs/slider/logo/casio.svg" alt="jobBox" /></Link></div>
              <div className="swiper-slide"><Link to="#"><img src="assets/imgs/slider/logo/dell.svg" alt="jobBox" /></Link></div>
              <div className="swiper-slide"><Link to="#"><img src="assets/imgs/slider/logo/panasonic.svg" alt="jobBox" /></Link></div>
              <div className="swiper-slide"><Link to="#"><img src="assets/imgs/slider/logo/vaio.svg" alt="jobBox" /></Link></div>
              <div className="swiper-slide"><Link to="#"><img src="assets/imgs/slider/logo/sharp.svg" alt="jobBox" /></Link></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="text-start">
        ...
        <div className="list-tabs mt-40">
          <ul className="nav nav-tabs" role="tablist">
            <li><Link className="active" id="nav-tab-job-1" to="#tab-job-1" data-bs-toggle="tab" role="tab" aria-controls="tab-job-1" aria-selected="true"><img src="assets/imgs/page/homepage1/management.svg" alt="jobBox" /> Management</Link></li>
            <li><Link id="nav-tab-job-2" to="#tab-job-2" data-bs-toggle="tab" role="tab" aria-controls="tab-job-2" aria-selected="false"><img src="assets/imgs/page/homepage1/marketing.svg" alt="jobBox" /> Marketing &amp; Sale</Link></li>
            <li><Link id="nav-tab-job-3" to="#tab-job-3" data-bs-toggle="tab" role="tab" aria-controls="tab-job-3" aria-selected="false"><img src="assets/imgs/page/homepage1/finance.svg" alt="jobBox" /> Finance</Link></li>
            <li><Link id="nav-tab-job-4" to="#tab-job-4" data-bs-toggle="tab" role="tab" aria-controls="tab-job-4" aria-selected="false"><img src="assets/imgs/page/homepage1/human.svg" alt="jobBox" /> Human Resource</Link></li>
            <li><Link id="nav-tab-job-5" to="#tab-job-5" data-bs-toggle="tab" role="tab" aria-controls="tab-job-5" aria-selected="false"><img src="assets/imgs/page/homepage1/retail.svg" alt="jobBox" /> Retail &amp; Products</Link></li>
            <li><Link id="nav-tab-job-6" to="#tab-job-6" data-bs-toggle="tab" role="tab" aria-controls="tab-job-6" aria-selected="false"><img src="assets/imgs/page/homepage1/content.svg" alt="jobBox" /> Content Writer</Link></li>
          </ul>
        </div>
      </div>
      <div className="mt-50">
            ...
            <div className="row">
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="card-grid-2 grid-bd-16 hover-up">
                  ...
                  <div className="card-block-info">
                    <h5><Link to="job-details">React Native Web Developer</Link></h5>
                    ...
                    <div className="card-2-bottom mt-20">
                      <div className="row">
                        <div className="col-xl-7 col-md-7 mb-2"><Link className="btn btn-tags-sm mr-5" to="jobs-grid">Figma</Link><Link className="btn btn-tags-sm mr-5" to="jobs-grid">Adobe XD</Link>
                        </div>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="card-grid-2 grid-bd-16 hover-up">
                  ...
                  <div className="card-block-info">
                    <h5><Link to="job-details">Digital Marketing Manager</Link></h5>
                    <div className="mt-5"><span className="card-location mr-15">Chicago, US</span><span className="card-time">6 mins ago</span></div>
                    <div className="card-2-bottom mt-20">
                      <div className="row">
                        <div className="col-xl-7 col-md-7 mb-2"><Link className="btn btn-tags-sm mr-5" to="jobs-grid">SEO</Link><Link className="btn btn-tags-sm mr-5" to="jobs-grid">Word</Link>
                        </div>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="card-grid-2 grid-bd-16 hover-up">
                  ...
                  <div className="card-block-info">
                    <h5><Link to="job-details">Web Designer/Developer</Link></h5>
                    <div className="mt-5"><span className="card-location mr-15">Chicago, US</span><span className="card-time">9 mins ago</span></div>
                    <div className="card-2-bottom mt-20">
                      <div className="row">
                        <div className="col-xl-7 col-md-7 mb-2"><Link className="btn btn-tags-sm mr-5" to="jobs-grid">HTML</Link><Link className="btn btn-tags-sm mr-5" to="jobs-grid">CSS</Link><Link className="btn btn-tags-sm mr-5" to="jobs-grid">JS</Link>
                        </div>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="card-grid-2 grid-bd-16 hover-up">
                  ...
                  <div className="card-block-info">
                    <h5><Link to="job-details">Full Stack Engineer</Link></h5>
                    <div className="mt-5"><span className="card-location mr-15">Chicago, US</span><span className="card-time">13 mins ago</span></div>
                    <div className="card-2-bottom mt-20">
                      <div className="row">
                        <div className="col-xl-7 col-md-7 mb-2"><Link className="btn btn-tags-sm mr-5" to="jobs-grid">NodeJS</Link><Link className="btn btn-tags-sm mr-5" to="jobs-grid">MongoDB</Link>
                        </div>
                        <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">$80 - $150</span><span className="text-muted">/Hour</span></div>
                      </div>
                    </div>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="card-grid-2 grid-bd-16 hover-up">
                  ...
                  <div className="card-block-info">
                    <h5><Link to="job-details">Frontend Developer Full time</Link></h5>
                    <div className="mt-5"><span className="card-location mr-15">Chicago, US</span><span className="card-time">16 mins ago</span></div>
                    <div className="card-2-bottom mt-20">
                      <div className="row">
                        <div className="col-xl-7 col-md-7 mb-2"><Link className="btn btn-tags-sm mr-5" to="jobs-grid">Bootstrap</Link>
                        </div>
                        <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">$80 - $150</span><span className="text-muted">/Hour</span></div>
                      </div>
                    </div>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="card-grid-2 grid-bd-16 hover-up">
                  ...
                  <div className="card-block-info">
                    <h5><Link to="job-details">React Native Mobile Developer</Link></h5>
                    <div className="mt-5"><span className="card-location mr-15">Chicago, US</span><span className="card-time">30 mins ago</span></div>
                    <div className="card-2-bottom mt-20">
                      <div className="row">
                        <div className="col-xl-7 col-md-7 mb-2"><Link className="btn btn-tags-sm mr-5" to="jobs-grid">React</Link><Link className="btn btn-tags-sm mr-5" to="jobs-grid">NextJS                      </Link>
                        </div>
                        <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">$80 - $150</span><span className="text-muted">/Hour</span></div>
                      </div>
                    </div>
          ...
          <div className="swiper-container swiper-group-6 mh-none swiper">
            <div className="swiper-wrapper pb-70 pt-5">
              <div className="swiper-slide hover-up">
                <div className="card-grid-5 card-category hover-up" style={{backgroundImage: 'url("assets/imgs/page/homepage2/img-big1.png")'}}><Link to="jobs-grid">
              ...
              <div className="swiper-slide hover-up">
                <div className="card-grid-5 card-category hover-up" style={{backgroundImage: 'url("assets/imgs/page/homepage2/img-big2.png")'}}><Link to="jobs-grid">
                    <div className="box-cover-img">
                      <div className="content-bottom">
              ...
              <div className="swiper-slide hover-up">
                <div className="card-grid-5 card-category hover-up" style={{backgroundImage: 'url("assets/imgs/page/homepage2/img-big3.png")'}}><Link to="jobs-grid">
                    <div className="box-cover-img">
                      <div className="content-bottom">
      ...
      <div className="container">
        <div className="row mt-50">
          <div className="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
            <div className="card-image-top hover-up"><Link to="jobs-grid">
                <div className="image" style={{backgroundImage: 'url(assets/imgs/page/homepage1/location1.png)'}}><span className="lbl-hot">Hot</span></div></Link>
              <div className="informations"><Link to="jobs-grid">
                  <h5>Paris, France</h5></Link>
                <div className="row">
          ...
          <div className="col-xl-4 col-lg-4 col-md-7 col-sm-12 col-12">
            <div className="card-image-top hover-up"><Link to="jobs-grid">
                <div className="image" style={{backgroundImage: 'url(assets/imgs/page/homepage1/location2.png)'}}><span className="lbl-hot">Trending</span></div></Link>
              <div className="informations"><Link to="jobs-grid">
                  <h5>London, England</h5></Link>
                <div className="row">
          ...
          <div className="col-xl-5 col-lg-5 col-md-7 col-sm-12 col-12">
            <div className="card-image-top hover-up"><Link to="jobs-grid">
                <div className="image" style={{backgroundImage: 'url(assets/imgs/page/homepage1/location3.png)'}}><span className="lbl-hot">Hot</span></div></Link>
              <div className="informations"><Link to="jobs-grid">
                  <h5>New York, USA</h5></Link>
                <div className="row">
          ...
          <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 col-12">
            <div className="card-image-top hover-up"><Link to="jobs-grid">
                <div className="image" style={{backgroundImage: 'url(assets/imgs/page/homepage1/location4.png)'}} /></Link>
              <div className="informations"><Link to="jobs-grid">
                  <h5>Amsterdam, Holland</h5></Link>
                <div className="row">
          ...
          <div className="col-xl-5 col-lg-5 col-md-7 col-sm-12 col-12">
            <div className="card-image-top hover-up"><Link to="jobs-grid">
                <div className="image" style={{backgroundImage: 'url(assets/imgs/page/homepage1/location5.png)'}} /></Link>
              <div className="informations"><Link to="jobs-grid">
                  <h5>Copenhagen, Denmark</h5></Link>
                <div className="row">
          ...
          <div className="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
            <div className="card-image-top hover-up"><Link to="jobs-grid">
                <div className="image" style={{backgroundImage: 'url(assets/imgs/page/homepage1/location6.png)'}} /></Link>
              <div className="informations"><Link to="jobs-grid">
                  <h5>Berlin, Germany</h5></Link>
                <div className="row">
        ...
        <div className="swiper-container swiper-group-1 swiper-style-2 swiper">
          <div className="swiper-wrapper pt-5">
            <div className="swiper-slide">
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    <div className="image-left"><img alt="jobBox" src="assets/imgs/brands/brand-1.png" /></div>
                    <div className="text-info-right">
                      <h4>Linkedin</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>68</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    ...
                    <div className="text-info-right">
                      <h4>Adobe</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>42</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    ...
                    <div className="text-info-right">
                      <h4>Dailymotion</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>46</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    ...
                    <div className="text-info-right">
                      <h4>NewSum</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>68</span><span>)</span></span>
                    </div>
                    <div className="text-info-bottom mt-5"><span className="font-xs color-text-mutted icon-location">New York, US</span><span className="font-xs color-text-mutted float-end mt-5">25<span> Open Jobs</span></span></div>
                  </div></Link></div>
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    ...
                    <div className="text-info-right">
                      <h4>PowerHome</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>87</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    ...
                    <div className="text-info-right">
                      <h4>Whop.com</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>34</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    ...
                    <div className="text-info-right">
                      <h4>Greewood</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>124</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    ...
                    <div className="text-info-right">
                      <h4>Kentucky</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>54</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    ...
                    <div className="text-info-right">
                      <h4>Qeuity</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>76</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    ...
                    <div className="text-info-right">
                      <h4>Honda</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>89</span><span>)</span></span>
                    </div>
                    <div className="text-info-bottom mt-5"><span className="font-xs color-text-mutted icon-location">New York, US</span><span className="font-xs color-text-mutted float-end mt-5">34<span> Open Jobs</span></span></div>
                  </div></Link></div>
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    <div className="image-left"><img alt="jobBox" src="assets/imgs/brands/brand-5.png" /></div>
                    <div className="text-info-right">
                      <h4>Toyota</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>34</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    <div className="image-left"><img alt="jobBox" src="assets/imgs/brands/brand-3.png" /></div>
                    <div className="text-info-right">
                      <h4>Lexuxs</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>27</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    <div className="image-left"><img alt="jobBox" src="assets/imgs/brands/brand-6.png" /></div>
                    <div className="text-info-right">
                      <h4>Ondo</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>54</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    <div className="image-left"><img alt="jobBox" src="assets/imgs/brands/brand-2.png" /></div>
                    <div className="text-info-right">
                      <h4>Square</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>16</span><span>)</span></span>
                    </div>
              ...
              <div className="item-5 hover-up wow animate__animated animate__fadeIn"><Link to="#">
                  <div className="item-logo">
                    <div className="image-left"><img alt="jobBox" src="assets/imgs/brands/brand-8.png" /></div>
                    <div className="text-info-right">
                      <h4>Vista</h4><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><img alt="jobBox" src="assets/imgs/template/icons/star.svg" /><span className="font-xs color-text-mutted ml-10"><span>(</span><span>97</span><span>)</span></span>
                    </div>
        ...
        <div className="col-lg-6 col-md-12 mb-15 mb-lg-0">
          <div className="box-radius-8 bg-urgent hover-up">
            ...
            <div className="text-info">
              ...
              <div className="mt-15"><Link className="btn btn-arrow-right" to="#">Find Out More</Link></div>
            </div>
          </div>
        </div>
