      ...
      <div className="row login-register-cover">
        <div className="col-lg-4 col-md-6 col-sm-12 mx-auto">
          ...
          <form className="login-register text-start mt-20" action="#">
            ...
            <div className="form-group">
              <button className="btn btn-brand-1 hover-up w-100" type="submit" name="continue">Continue</button>
            </div>
            <div className="text-muted text-center">Don't have an Account? <Link to="register">Sign up</Link></div>
          </form>
        </div>
        <div className="img-1 d-none d-lg-block"><img className="shape-1" src="assets/imgs/page/login-register/img-5.svg" alt="JobBox" /></div>
