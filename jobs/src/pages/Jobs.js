    ...
    <div className="container">
      <div className="banner-hero banner-single banner-single-bg">
        <div className="block-banner text-center">
          <h3 className="wow animate__animated animate__fadeInUp"><span className="color-brand-2">22 Jobs</span> Available Now</h3>
              ...
              <div className="row">
                ...
                <div className="col-xl-6 col-lg-7 text-lg-end mt-sm-15">
                  <div className="display-flex2">
                    ...
                    <div className="box-view-type"><Link className="view-type" to="jobs-list"><img src="assets/imgs/template/icons/icon-list.svg" alt="jobBox" /></Link><Link className="view-type" to="jobs-grid"><img src="assets/imgs/template/icons/icon-grid-hover.svg" alt="jobBox" /></Link></div>
                  </div>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="card-grid-2 hover-up">
                  <div className="card-grid-2-image-left"><span className="flash" />
                    ...
                    <div className="right-info"><Link className="name-job" to="company-details">LinkedIn</Link><span className="location-small">New York, US</span></div>
                  </div>
                  <div className="card-block-info">
                    <h6><Link to="job-details">UI / UX Designer fulltime</Link></h6>
                    ...
                    <div className="mt-30"><Link className="btn btn-grey-small mr-5" to="jobs-grid">Adobe XD</Link><Link className="btn btn-grey-small mr-5" to="jobs-grid">Figma</Link><Link className="btn btn-grey-small mr-5" to="jobs-grid">Photoshop</Link>
                    </div>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="card-grid-2 hover-up">
                  <div className="card-grid-2-image-left"><span className="flash" />
                    ...
                    <div className="right-info"><Link className="name-job" to="company-details">Adobe Ilustrator</Link><span className="location-small">New York, US</span></div>
                  </div>
                  <div className="card-block-info">
                    <h6><Link to="job-details">Full Stack Engineer</Link></h6>
                    ...
                    <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                    <div className="mt-30"><Link className="btn btn-grey-small mr-5" to="jobs-grid">React</Link><Link className="btn btn-grey-small mr-5" to="jobs-grid">NodeJS</Link>
                    </div>
                    <div className="card-2-bottom mt-30">
                      <div className="row">
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="card-grid-2 hover-up">
                  <div className="card-grid-2-image-left"><span className="flash" />
                    ...
                    <div className="right-info"><Link className="name-job" to="company-details">Bing Search</Link><span className="location-small">New York, US</span></div>
                  </div>
                  <div className="card-block-info">
                    <h6><Link to="job-details">Java Software Engineer</Link></h6>
                    ...
                    <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                    <div className="mt-30"><Link className="btn btn-grey-small mr-5" to="jobs-grid">Python</Link><Link className="btn btn-grey-small mr-5" to="jobs-grid">AWS</Link><Link className="btn btn-grey-small mr-5" to="jobs-grid">Photoshop</Link>
                    </div>
                    <div className="card-2-bottom mt-30">
                      <div className="row">
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="card-grid-2 hover-up">
                  ...
                  <div className="card-block-info">
                    <h6><Link to="job-details">React Native Web Developer</Link></h6>
                    <div className="mt-5"><span className="card-briefcase">Fulltime</span><span className="card-time">4<span> minutes ago</span></span></div>
                    <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur</p>
                    <div className="mt-30"><Link className="btn btn-grey-small mr-5" to="jobs-grid">Angular</Link>
                    </div>
                    <div className="card-2-bottom mt-30">
                      <div className="row">
                        <div className="col-lg-7 col-7"><span className="card-text-price">$500</span><span className="text-muted">/Hour</span></div>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="card-grid-2 hover-up">
                  <div className="card-grid-2-image-left"><span className="flash" />
                    ...
                    <div className="right-info"><Link className="name-job" to="company-details">Nintendo</Link><span className="location-small">New York, US</span></div>
                  </div>
                  <div className="card-block-info">
                    <h6><Link to="job-details">Products Manager</Link></h6>
                    <div className="mt-5"><span className="card-briefcase">Full time</span><span className="card-time">6<span> minutes ago</span></span></div>
                    <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                    <div className="mt-30"><Link className="btn btn-grey-small mr-5" to="job-details">ASP .Net</Link><Link className="btn btn-grey-small mr-5" to="job-details">Figma</Link>
                    </div>
                    <div className="card-2-bottom mt-30">
                      <div className="row">
                        <div className="col-lg-7 col-7"><span className="card-text-price">$250</span><span className="text-muted">/Hour</span></div>
