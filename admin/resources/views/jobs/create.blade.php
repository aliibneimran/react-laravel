                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group mb-30">
                                                ...
                                                <input class="form-control" type="text" placeholder="e.g. &quot;New York City&quot; or &quot;San Francisco”" name="location">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group mb-30">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group mb-30">
                                                ...
                                                <input class="form-control" type="text" placeholder="Figma, UI/UX, Sketch..." name="tag">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group mb-30">
