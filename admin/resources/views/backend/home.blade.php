    ...
    <div class="col-xxl-8 col-xl-7 col-lg-7">
        <div class="section-box">
            <div class="row">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="assets/imgs/page/dashboard/bank.svg" alt="jobBox">
                        </div>
                        <div class="card-info">
                            <div class="card-title">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="assets/imgs/page/dashboard/lamp.svg" alt="jobBox">
                        </div>
                        <div class="card-info">
                            <div class="card-title">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="assets/imgs/page/dashboard/look.svg" alt="jobBox">
                        </div>
                        <div class="card-info">
                            <div class="card-title">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="assets/imgs/page/dashboard/doc.svg" alt="jobBox">
                        </div>
                        <div class="card-info">
                            <div class="card-title">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="assets/imgs/page/dashboard/man.svg" alt="jobBox">
                        </div>
                        <div class="card-info">
                            <div class="card-title">
                    ...
                    <div class="panel-body">
                        <div class="card-style-2 hover-up">
                            <div class="card-head">
                                ...
                                <div class="card-title">
                                    <h6>Senior Full Stack Engineer, Creator Success</h6><span class="job-type">Full time</span><span class="time-post">3mins
                                        ago</span><span class="location">New York, US</span>
                                </div>
                            </div>
                            <div class="card-tags"> <a class="btn btn-tag">Figma</a><a class="btn btn-tag">Adobe
                                    XD</a>
                            </div>
                        ...
                        <div class="card-style-2 hover-up">
                            ...
                            <div class="card-tags"> <a class="btn btn-tag">Figma</a><a class="btn btn-tag">Adobe
                                    XD</a><a class="btn btn-tag">PSD</a>
                            </div>
                            ...
                            <div class="card-head">
                                ...
                                <div class="card-title">
                                    <h6>Lead Product/UX/UI Designer Role</h6><span class="job-type">Full
                                        time</span><span class="time-post">3mins ago</span><span class="location">Paris, France</span>
                                </div>
                            </div>
                            <div class="card-tags"> <a class="btn btn-tag">Figma</a><a class="btn btn-tag">Adobe
                                    XD</a><a class="btn btn-tag">PSD</a>
                            ...
                            <div class="card-head">
                                ...
                                <div class="card-title">
                                    <h6>Marketing Graphic Designer</h6><span class="job-type">Full
                                        time</span><span class="time-post">3mins ago</span><span class="location">Tokyto, Japan</span>
                                </div>
                            </div>
                            <div class="card-tags"> <a class="btn btn-tag">Figma</a><a class="btn btn-tag">Adobe
                                    XD</a><a class="btn btn-tag">PSD</a>
                            ...
                            <div class="card-head">
                                ...
                                <div class="card-title">
                                    <h6>Director, Product Design - Creator</h6><span class="job-type">Full
                                        time</span><span class="time-post">3mins ago</span><span class="location">Ha Noi, Vietnam</span>
                                </div>
                            </div>
                            <div class="card-tags"> <a class="btn btn-tag">Figma</a><a class="btn btn-tag">Adobe
                                    XD</a><a class="btn btn-tag">PSD</a>
                ...
                <div class="panel-white">
                    ...
                    <div class="panel-body">
                        <div class="card-style-3 hover-up">
                            ...
                            <div class="card-rating"><img src="assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="assets/imgs/page/dashboard/star.svg" alt="jobBox">
                                <img src="assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="assets/imgs/page/dashboard/star.svg" alt="jobBox"> <span class="font-xs color-text-mutted">
                                    (65)</span>
                            </div>
                        </div>
                        <div class="card-style-3 hover-up">
                        ...
                        <div class="row">
                                ...
                                <div class="card-style-4 hover-up">
                                    <div class="d-flex">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <img src="assets/imgs/page/dashboard/star-none.svg" alt="jobBox">
                            ...
                            <div class="col-lg-6 col-md-6 pr-5 pl-5">
                                <div class="card-style-4 hover-up">
                                    ...
                                    <div class="card-location d-flex"><span class="location">Chicago,
                                            US</span><span class="jobs-number">25 Open Jobs</span></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 pr-5 pl-5">
                                <div class="card-style-4 hover-up">
                                    ...
                                    <div class="card-location d-flex"><span class="location">Austin,
                                            TX</span><span class="jobs-number">25 Open Jobs</span></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 pr-5 pl-5">
                                <div class="card-style-4 hover-up">
                            ...
                            <div class="col-lg-6 col-md-6 pr-5 pl-5">
                                <div class="card-style-4 hover-up">
                                    ...
                                    <div class="card-location d-flex"><span class="location">Boston,
                                            US</span><span class="jobs-number">25 Open Jobs</span></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 pr-5 pl-5">
