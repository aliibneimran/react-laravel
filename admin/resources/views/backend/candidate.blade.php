...
<div class="box-heading">
    ...
    <div class="box-breadcrumb">
        <div class="breadcrumbs">
            <ul>
                <li> <a class="icon-home" href="/admin">Admin</a></li>
                        ...
                        <div class="row">
                                ...
                                <div class="card-grid-2 hover-up">
                                    <div class="card-grid-2-image-left">
                                        <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                <figure><img alt="jobBox" src="{{asset('')}}assets/imgs/page/candidates/user1.png"></figure>
                                            </a></div>
                                        <div class="card-profile pt-10"><a href="candidate-details.html">
                                                <h5>Robert Fox</h5>
                                            </a><span class="font-xs color-text-mutted">UI/UX Designer</span>
                                            <div class="rate-reviews-small pt-5"><span><img src="{{asset('')}}assets/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="{{asset('')}}assets/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="{{asset('')}}assets/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="{{asset('')}}assets/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="{{asset('')}}assets/imgs/template/icons/star.svg" alt="jobBox"></span><span class="ml-10 color-text-mutted font-xs">(65)</span></div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card-grid-2 hover-up">
                                    <div class="card-grid-2-image-left">
                                        <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                <figure><img alt="jobBox" src="{{asset('')}}assets/imgs/page/candidates/user2.png"></figure>
                                            </a></div>
                                        <div class="card-profile pt-10"><a href="candidate-details.html">
                                                <h5>Cody Fisher</h5>
