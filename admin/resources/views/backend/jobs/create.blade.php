                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group mb-30">
                                                ...
                                                <input class="form-control" type="text"
                                                    placeholder="e.g. Senior Product Designer" name="title">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group mb-30">
                                                <label class="font-sm color-text-mutted mb-10">Add your job description
                                                    *</label>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group mb-30">
                                                ...
                                                <input class="form-control" type="text"
                                                    placeholder="Figma, UI/UX, Sketch..." name="tag">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group mb-30">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group mb-30 box-file-uploaded d-flex align-items-center">
                                                <span>Job_required.pdf</span><a class="btn btn-delete">Delete</a>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group mt-10">
                                                <button class="btn btn-default btn-brand icon-tick" type="submit">Post
                                                    New Job</button>
                                            </div>
                                        </div>
                                    </div>
